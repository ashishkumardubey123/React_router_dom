...
const features = [
  { icon: "⚡", title: "Lightning Fast Sites", desc: "Vite + React for instant builds and blazing load times." },
  { icon: "📱", title: "Mobile First", desc: "Responsive Tailwind designs that work perfectly on all devices." },
  { icon: "🔍", title: "SEO Optimized", desc: "Meta tags, semantic HTML, and performance for top rankings." },
  { icon: "🚀", title: "Modern Stack", desc: "React 18, Tailwind CSS, Headless UI, and API integrations." },
  { icon: "🛡️", title: "Clean Code", desc: "Component-based, reusable, and well-documented code." },
  { icon: "⚙️", title: "Custom Features", desc: "Forms, animations, auth, and whatever your project needs." }
];
...
const testimonials = [
  { quote: "Delivered a fast, SEO-ready site in record time!", author: "Client A" },
  { quote: "Perfect React components, mobile-first approach.", author: "Client B" }
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="text-center mb-20">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold mb-6">
            ...
            <br />
            <span className="text-amber-400">With React & Tailwind</span>
          </h1>
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-semibold text-center mb-16">What's Included</h2>
        ...
        <section className="mb-20 bg-slate-800/50 rounded-3xl p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold mb-4">My 5-Step Process</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Transparent workflow from idea to live site.
            </p>
          </div>
        ...
        <section className="text-center">
          <h2 className="text-3xl font-semibold mb-6">Ready for Your Site?</h2>
          <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
            Get a custom quote for web development tailored to your needs.
          </p>
          <a
            href="/contact"
